...
const UserProfile = ({ navigation }) => {
  ...
  useEffect(() => {
    fetch("https://fonder.edwardlin.ca/api/v1/users/read.php?id=" + userId)
      .then((res) => res.json())
      .then((result) => {
        setName(result.users[0]);
      });
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profile}>
        ...
        />
        <Text style={styles.profileName}>{name.first_name + " " + name.last_name}</Text>
      </View>
      ...
      <View style={styles.accountSettings}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("CuisinesSelection")}
        >
          <Text style={styles.subheadingText}>
            Cuisine Selection{"\n"}
            <Text style={styles.description}>
              Choose your favourite cuisine types
            </Text>
          </Text>
          <Ionicons
            name="chevron-forward-outline"
      ...
      <View style={styles.inviteBox}>
        ...
        <View style={styles.inviteText}>
          ...
          >
            Get $10 Fonder credits and give $10 Fonder credits for every
            referral
          </Text>
        ...
        <Image
          ...
          source={require("../assets/img/profile-invite-ppl.png")}
        />
      </View>
    </View>
  );
